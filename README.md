...
| [scripts/test-ows-x402.sh](scripts/test-ows-x402.sh) | Example `ows pay request` (set env vars; no secrets in repo) |
...
Derived from the private mail-server integration in **x402-bot-mailbox**; this repo is the minimal **public** surface for reviewers and agents.
